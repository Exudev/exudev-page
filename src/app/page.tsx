    ...
    <div className={darkMode ? "dark": ""}>
            ...
            <ul className="flex items-center">
              ...
              <li>
                <a
                   ...
                   href="./props/exudev-vitae.pdf" download ="exudev-vitae"
                >
                  Resume
                </a>
              </li>
      ...
      <div className="rounded-full overflow-hidden" >
        ...
        />
            ...
            <h2 className = "text-5xl py-2 text-purple-900 font-medium">Pablo Edu Diaz</h2>
          ...
          <div className="text-5xl flex justify-center gap-16 py-3 text-gra-600">
            <a href="https://www.linkedin.com/in/pablo-eduardo-diaz-hernandez-a1b457183/">  <AiFillLinkedin className="icon text-black-500 hover:text-purple-950" /></a>
            <a href="https://twitter.com/pabloedudh"> <AiFillTwitterCircle  className="icon text-black-500 hover:text-purple-950"/></a>
            <a href="https://github.com/Exudev">  <AiFillGithub className="icon text-black-500 hover:text-purple-700"/> </a>
          </div>
          <div className="">
        ...
        <section id="projects">
          <div className="text-center p-10" >
            <h3 className="text-2xl py-2 dark:text-white md:text-3xl">Few of my projects</h3>
        <Card description="Juego de mesa con cartas, utilice JS" imageSrc="/CartasLocas.png" title="Cartas Locas"/>
          </div>
        </section>
      </main>
    </div>
