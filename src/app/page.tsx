      ...
      <main className=" bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-40">
        <section id="main" className="min-h-screen">
          ...
          <div className="text-center p-3">
            ...
            <p className="text-md py-2 leading-8 text-black   dark:text-white">
              ...
              design. My current focus is on the use of programming languages such as C#
            ...
            <p className="text-md py-2 leading-8 text-black   dark:text-white">
              ...
              interests, including video games,horror movies,  reading comics, and cultivating
        ...
        <section id="projects">
          <div className="text-center p-3"  >
            ...
            />
               <Card
              description="ParkingSpot is an innovative application designed to mitigate traffic congestion. Here i used, Node Js, Mongo DB, React and some other tools."
